...
const Redirect = (paramater) => {
  console.log(paramater, "Param")
}
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open}  style={{backgroundColor: "white"}}>
        <Toolbar>
          ...
          <button style={{ position: 'absolute', top: 0, right: 0, margin: '10px'}}
          ...
          {['Inbox', 'Starred', 'Send email', 'Drafts'].map((text, index) => (
            <ListItem key={text} disablePadding >
              <ListItemButton >
                ...
                <ListItemText primary={text } onClick={Redirect(text)} />
              </ListItemButton>
            </ListItem>
          ))}
        </List>
